        ...
        <div className='font-poppins relative min-h-screen'>
            ...
            <div className='w-11/12 mx-auto '>
                ...
                <div className='grid grid-cols-2 justify-center gap-x-2 gap-y-4 mb-8'>
                    <div onClick={(e)=>navigateToSearch("Respect")} style={{ backgroundColor: 'rgba(154, 134, 164, 0.25)' }} className='w-[155px] h-[115px] rounded-2xl px-3 py-2 relative'>
                    ...
                    <div onClick={(e)=>navigateToSearch("Good Luck")} style={{ backgroundColor: 'rgba(177, 188, 230, 0.25)' }} className='w-[155px] h-[115px] rounded-2xl px-3 py-2 relative'>
                        <div className='flex items-center justify-start space-x-1 '>
                    ...
                    <div onClick={(e)=>navigateToSearch("Promise")} style={{ backgroundColor: 'rgba(183, 229, 221, 0.25)' }} className='w-[155px] h-[115px] rounded-2xl px-3 py-2 relative'>
                        <div className='flex items-center justify-start space-x-1 '>
                            <img src={promise} alt="" />
                    ...
                    <div onClick={(e)=>navigateToSearch("Feedback")} style={{ backgroundColor: 'rgba(241, 240, 192, 0.25)' }} className='w-[155px] h-[115px] rounded-2xl px-3 py-2 relative'>
                        <div className='flex items-center justify-start space-x-1 '>
