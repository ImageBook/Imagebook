        ...
        <>
          ...
          <div className='w-11/12 mx-auto mt-12'>
            ...
            <div className='grid grid-cols-2 justify-center gap-x-2 gap-y-4 mb-8'>
              <div onClick={(e) => navigateToDisplay("Respect")} style={{ backgroundColor: 'rgba(154, 134, 164, 0.25)' }} className='w-[155px] h-[115px] rounded-2xl px-3 py-2 relative hover:cursor-pointer'>
              ...
              <div onClick={(e) => navigateToDisplay("Good Luck")} style={{ backgroundColor: 'rgba(177, 188, 230, 0.25)' }} className='w-[155px] h-[115px] rounded-2xl px-3 py-2 relative hover:cursor-pointer'>
                <div className='flex items-center justify-start space-x-1 '>
              ...
              <div onClick={(e) => navigateToDisplay("Promise")} style={{ backgroundColor: 'rgba(183, 229, 221, 0.25)' }} className='w-[155px] h-[115px] rounded-2xl px-3 py-2 relative hover:cursor-pointer'>
                <div className='flex items-center justify-start space-x-1 '>
                  <img src={promise} alt="" />
              ...
              <div onClick={(e) => navigateToDisplay("Feedback")} style={{ backgroundColor: 'rgba(241, 240, 192, 0.25)' }} className='w-[155px] h-[115px] rounded-2xl px-3 py-2 relative hover:cursor-pointer'>
                <div className='flex items-center justify-start space-x-1 '>
