...
const DisplayVideo = () => {
    ...
    return (
        <div>
            ...
            <div style={{ height: 'calc(100vh - 200px)' }} className='relative object-cover w-full'>
                <video className='object-cover w-full' controls src={state.video}></video>
                <div className='absolute right-6 bottom-8 space-y-3'>
